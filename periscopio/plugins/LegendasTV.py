...
class LegendasTV(SubtitleDatabase.SubtitleDB):
    ...
    user_agent = "LegendasTV/1.0 (periscopio/0.1; http://code.google.com/p/periscopio)"
    ...
    def process(self, filepath, langs):
        ...
        if not self.user or self.user == "":
            log.error("LegendasTV requires a personnal username/password. Set one up in your ~/.config/periscopio/config file")
            return []
